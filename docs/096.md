...
<figure style="width: 1100px" class="wp-caption alignnone">![A screenshot of the MyKinsta dashboard.](../Images/0bb433f8e048411649811de1ef71eada.png)

<figcaption class="wp-caption-text">The MyKinsta dashboard.</figcaption>
...
<figure style="width: 1100px" class="wp-caption alignnone">![A screenshot of Kinsta's automated backups feature.](../Images/0448bd4a277fd903bec4f88e612e5b3b.png)

<figcaption class="wp-caption-text">MyKinsta’s automated backups feature.</figcaption>

</figure>

Kinsta 的代理计划包括为您托管的每个客户站点保留 30 天的备份。这意味着您可以快速修复客户网站的任何不可预见的问题。

<figure style="width: 1100px" class="wp-caption alignnone">![A screenshot of Kinsta's environment backups feature showing hourly backup options.](../Images/7b4aca302319ef68a05a1c83acc52adf.png)

<figcaption class="wp-caption-text">Setting up hourly backups through MyKinsta.</figcaption>
...
<figure style="width: 1200px" class="wp-caption alignnone">![A graph of WordPress vulnerabilities and average CVSS scores.](../Images/76fbe67b29dcad5690d57ae8833ed41c.png)

<figcaption class="wp-caption-text">WordPress vulnerabilities more than doubled in 2021\. (Source: [Risk Based Security](https://www.riskbasedsecurity.com/2022/01/11/wordpress-vulnerabilities-more-than-doubled-in-2021/))</figcaption>
...
<figure style="width: 1110px" class="wp-caption alignnone">![An illustration of how web cache works.](../Images/00abc939ba5c522048ebe288d7166155.png)

<figcaption class="wp-caption-text">How web cache works.</figcaption>
...
<figure style="width: 1100px" class="wp-caption alignnone">![A screen comparing speed test results of the same site without and with caching.](../Images/1e5cb8c33707fc0ea93754280cdfb6b4.png)

<figcaption class="wp-caption-text">Speed test results for a site without and with caching.</figcaption>
...
<figure style="width: 1100px" class="wp-caption alignnone">![A screen showing how to clear cache through the MyKinsta-dashboard.](../Images/b0df2ab92c442e383916b5d818ecc878.png)

<figcaption class="wp-caption-text">Clearing cache in MyKinsta dashboard.</figcaption>
...
<figure style="width: 1100px" class="wp-caption alignnone">![Requesting site migrations through the MyKinsta dashboard.](../Images/cd555a5da9ac42c24654e77e195756da.png)

<figcaption class="wp-caption-text">Requesting a site migration through MyKinsta.</figcaption>
...
<figure style="width: 1600px" class="wp-caption alignnone">![A Kinsta CDN speed tests comparison graph.](../Images/a6d56887387c6edaacb162104b1cfee1.png)

<figcaption class="wp-caption-text">CDN speed tests graph for various global locations.</figcaption>
...
<figure style="width: 1100px" class="wp-caption alignnone">![An infographic of Kinsta's Support team stats.](../Images/9fbc773677213d742799b65fbe12a350.png)

<figcaption class="wp-caption-text">Kinsta Support stats.</figcaption>
...
<figure style="width: 1100px" class="wp-caption alignnone">![Switching between live and staging environments in MyKinsta.](../Images/03ec09b990425de057159866d5e4441b.png)

<figcaption class="wp-caption-text">Switching between Live and Staging environments in MyKinsta.</figcaption>
...
<figure style="width: 1024px" class="wp-caption alignnone">![DevKinsta user interface and how it looks.](../Images/e5af2c6cc88c10fe8e1bc40c898f8e22.png)

<figcaption class="wp-caption-text">DevKinsta is a WordPress local development tool.</figcaption>
...
<figure style="width: 1500px" class="wp-caption alignnone">![White labeling the Kinsta MU plugin with its before and after pictures.](../Images/9d6500edaa5b68ef7042ce930672fd06.png)

<figcaption class="wp-caption-text">Before and after screens of white-labeling Kinsta-branded elements.</figcaption>
...
<figure style="width: 1100px" class="wp-caption alignnone">![Kinsta is an agency-focused managed hosting platform, and it supports agencies with its Kinsta Agency Directory.](../Images/807d038ea05338238fb79bfaf822c56a.png)

<figcaption class="wp-caption-text">Kinsta Agency Directory.</figcaption>

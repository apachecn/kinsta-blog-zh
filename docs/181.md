...
<figcaption id="caption-attachment-114305" class="wp-caption-text">Git push.</figcaption>
...
6.  Add your SSH key.
    ...
    <figcaption id="caption-attachment-114313" class="wp-caption-text">添加 SSH 按键。</figcaption>

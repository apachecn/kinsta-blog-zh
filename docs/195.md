...
<figcaption id="caption-attachment-112432" class="wp-caption-text">In the future, you can control the link state color. (Image source [GitHub](https://github.com/WordPress/gutenberg/issues/34574))</figcaption>

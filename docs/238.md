...
<figcaption class="wp-caption-text">双向数据绑定。(图片来源:[堆栈溢出](https://stackoverflow.com/questions/13504906/what-is-two-way-binding) )</figcaption>
...
<figcaption class="wp-caption-text">棱角分明 vs 人缘平平。</figcaption>

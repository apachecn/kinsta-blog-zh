...
<figure style="width: 1500px" class="wp-caption alignnone">![The Figma editor.](../Images/d30006b4e9af5cd9f64188e4f73df638.png)
...
Sourcetree 不是一个 Git 存储库主机，而是一个用于管理它们的图形用户界面(GUI)。它是众多解决方案之一，比如 [GitKraken](https://www.gitkraken.com/) 、 [Sublime Merge](https://www.sublimemerge.com/) 、 [GitHub 桌面](https://desktop.github.com/)、[更多](https://git-scm.com/downloads/guis)。
...
<figure style="width: 900px" class="wp-caption alignnone">![Brave’s Security tab.](../Images/406a809ce0c70181423c499acfde00eb.png)
...
<figcaption class="wp-caption-text">The HTML5 Boilerplate homepage.</figcaption>
...
<figcaption class="wp-caption-text">The Express.js homepage.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The Taskade chat window.](../Images/7f806371f351fb0be194e23bc3f04e79.png)
...
<figcaption class="wp-caption-text">The elements that make up a Basecamp project.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The ShortPixel website.](../Images/488cdb71bab3141c350f420e97646a2a.png)

<figcaption class="wp-caption-text">The ShortPixel website.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![Downloading images from ShortPixel.](../Images/beb68abea5cfb282f2acfc44b07a0c93.png)

<figcaption class="wp-caption-text">Downloading images from ShortPixel.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The TinyPNG website.](../Images/7d604f64080fad2cf67a66a4dc1826c2.png)

<figcaption class="wp-caption-text">The TinyPNG website.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The Responsively app.](../Images/3e6fccc097d88f28d96551db2ab5eb1a.png)

<figcaption class="wp-caption-text">The Responsively app.</figcaption>

</figure>

如果你曾经被你需要在你的应用中执行和完善的媒体查询的数量所淹没，[相应地检查一下](https://responsively.app)。这是一个开源的前端工具，可以帮助你根据你选择的设备的不同视窗来开发网站。

<figure style="width: 900px" class="wp-caption alignnone">![Viewing different devices in Responsively.](../Images/7f9c86acb20b9eab48d8fd591de232ec.png)

<figcaption class="wp-caption-text">Viewing different devices in Responsively.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The Responsively inspector.](../Images/013625526d0f9121da378260b7f64124.png)

<figcaption class="wp-caption-text">The Responsively inspector.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![Google’s PageSpeed Insights.](../Images/34b672005bb756b9cfe7bb7456f85a17.png)

<figcaption class="wp-caption-text">Google’s PageSpeed Insights.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The Cypress homepage.](../Images/568874e2d38b760475ede2b7a1dd8409.png)

<figcaption class="wp-caption-text">The Cypress homepage.</figcaption>
...
<figure style="width: 1500px" class="wp-caption alignnone">![The Stack Overflow website.](../Images/6ab45fc14043d555223c6f49d0b7ad74.png)

<figcaption class="wp-caption-text">The Stack Overflow website.</figcaption>

</figure>

这是一个专注于编程的问答网站，也是涵盖所有其他主题的[栈交换](http://stackexchange.com)网络的一部分:

<figure style="width: 1500px" class="wp-caption alignnone">![One of many niche sites in the Stack Exchange network.](../Images/b1bf9202c2aa27521da48a1427400bbc.png)

<figcaption class="wp-caption-text">One of many niche sites in the Stack Exchange network.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The MDN Web Docs homepage.](../Images/e13176f5c531235c57d7a9250f8e8d37.png)

<figcaption class="wp-caption-text">The MDN Web Docs homepage.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![MDN Web Docs JavaScript page.](../Images/de6de9744ec68debbf7401af18b9a75c.png)

<figcaption class="wp-caption-text">MDN Web Docs JavaScript page.</figcaption>

</figure>

还有对各种行业的广泛观察，如游戏开发和在该领域开始需要什么:

<figure style="width: 900px" class="wp-caption alignnone">![The MDN guide on game development.](../Images/e604bdb4787561ca504d4c194a093740.png)

<figcaption class="wp-caption-text">MDN Web Doc’s guide on game development.</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The DevDocs homepage.](../Images/a518923d108129e750162653a0884f78.png)

<figcaption class="wp-caption-text">The DevDocs homepage.</figcaption>

</figure>

在浏览这个库之前，您需要启用您想要的 API 文档。您可以在**首选项**屏幕中完成此操作:

<figure style="width: 900px" class="wp-caption alignnone">![The DevDocs Preferences screen.](../Images/e8896ece30c81ee0fdb8655fc9c52c2f.png)

<figcaption class="wp-caption-text">The DevDocs Preferences screen.</figcaption>

</figure>

完成后，您将能够从专用的树形菜单中访问相关文档:

<figure style="width: 900px" class="wp-caption alignnone">![The WordPress API screen.](../Images/2a413b44f9b4b35e4b6560128a316078.png)

<figcaption class="wp-caption-text">The WordPress API screen.</figcaption>
...
Chris Coyier 是许多 web 开发人员都知道的一个名字。我们打赌你已经熟悉了他创建的网站—[CSS—Tricks](https://css-tricks.com/)。顾名思义，这是一个致力于前端编码，特别是 CSS，以及如何变得更好的网站。

<figure style="width: 900px" class="wp-caption alignnone">![The CSS-Tricks homepage.](../Images/2d1a981d3eb24a3be6e4e5bd8bfdd1a9.png)

<figcaption class="wp-caption-text">The CSS-Tricks homepage.</figcaption>

</figure>

正如[关于页面注释](https://css-tricks.com/about/)所言，最初几年，CSS 是主要话题。然而，从那以后，HTML、JavaScript、WordPress 等等变得同样重要，并且经常被讨论。结果是一个专注于前端开发的网站，有大量的文章、视频和指南来启发你。

<figure style="width: 900px" class="wp-caption alignnone">![The blogroll for CSS-Tricks.](../Images/1b1a903a29517f21aea094c2b3526816.png)

<figcaption class="wp-caption-text">The blogroll for CSS-Tricks.</figcaption>

</figure>

一个简单但有价值的元素是 [CSS 历书](https://css-tricks.com/almanac/)，它概述了 CSS 中的选择器和属性。如果你需要掌握这门语言的某些方面，这是一个很好的参考资料。

<figure style="width: 900px" class="wp-caption alignnone">![The CSS-Tricks Almanac.](../Images/20575249d7faab81790e64a16c1a411d.png)

<figcaption class="wp-caption-text">The CSS-Tricks Almanac.</figcaption>

</figure>

虽然 CSS-Tricks 有类似参考的方面，但它本身并不是参考资源*。不过，不管是通过 RSS 提要还是其他解决方案，它都应该是你经常去的地方。内容质量很高，能以你以前想不到的方式挑战你。至少，[订阅时事通讯](https://css-tricks.com/newsletter/246-communication-is-key/)，等待 CSS-Tricks 进入你的收件箱。*

 *#### 59.开发社区

想象一下，你可以从社交媒体、网络开发和堆栈溢出中提取优秀的部分，然后创建一个将它们融合在一起的网站。结果可能是[开发社区](http://dev.to)。

<figure style="width: 900px" class="wp-caption alignnone">![The DEV Community homepage.](../Images/5f4bba379dfae8f693ce93c371cc4ef0.png)

<figcaption class="wp-caption-text">The DEV Community homepage.</figcaption>

</figure>

这是一个博客平台，也是一个寻找发展问题答案的途径。您选择要关注的标签和人员，您的新闻订阅源就变成了一个自动化的、有管理的帖子和见解时间轴:

<figure style="width: 900px" class="wp-caption alignnone">![The DEV Community timeline for the JavaScript tag.](../Images/3813423ed5722bc3920321cdff5af2b8.png)

<figcaption class="wp-caption-text">The DEV Community timeline for the JavaScript tag.</figcaption>
...
*[我能用…](https://caniuse.com/)* 是[前端开发者对“*有没有问 Jeeves 要 CSS 的？*”](https://kinsta.com/blog/frontend-developer/)

<figure style="width: 900px" class="wp-caption alignnone">![The Can I use… homepage.](../Images/0e4a09d223e8e6b626bebddd65368dd5.png)

<figcaption class="wp-caption-text">The Can I use… homepage.</figcaption>

</figure>

前提很简单:您在搜索字段中键入 CSS 选择器或属性，数据库会返回您是否可以使用它来创建网站。你也不局限于 CSS。还支持 JavaScript 和 HTML:

<figure style="width: 900px" class="wp-caption alignnone">![Searching for an HTML element in Can I use…](../Images/b48106ac68dd6d56d9e33ec53b5b3e91.png)

<figcaption class="wp-caption-text">Searching for an HTML element in Can I use…</figcaption>
...
<figure style="width: 900px" class="wp-caption alignnone">![The browser support table in Can I use…](../Images/4745f878e2a08defa254f1e5be47700d.png)

<figcaption class="wp-caption-text">The browser support table in *Can I use…*</figcaption>

</figure>

如果仔细观察，还可以发现一些统计数据，例如元素的发布日期和使用百分比:

<figure style="width: 900px" class="wp-caption alignnone">![Information for a specific element in Can I use…](../Images/c8c7672fdf29557c82cd8aaa08248784.png)

<figcaption class="wp-caption-text">Information for a specific element in Can I use…</figcaption>

</figure>

总的来说，*我能用吗……*可能不会经常使用。不过，在项目的某些阶段，它几乎会一直开放。一旦你弄清楚你的目标浏览器将支持什么，*我可以使用…* 重新放回你的书签，等待下一次需要它的时候。这是一个有用的服务，当涉及到您的前端代码时，它可以是一个“水载体”。

[From wireframing to design to building collaborative workflows, there's a lot that goes into a successful development project 👨‍💻 These tools will help you keep things streamlined 😌Click to Tweet](https://twitter.com/intent/tweet?url=https%3A%2F%2Fkinsta.com%2Fblog%2Fweb-development-tools%2F&via=kinsta&text=From+wireframing+to+design+to+building+collaborative+workflows%2C+there%27s+a+lot+that+goes+into+a+successful+development+project+%F0%9F%91%A8%E2%80%8D%F0%9F%92%BB+These+tools+will+help+you+keep+things+streamlined+%F0%9F%98%8C&hashtags=WebDeveloper%2CWebDev)
...
无论您选择使用什么样的 web 开发工具， [Kinsta 客户](https://kinsta.com/plans/?plan=visits-business1&interval=month)都可以通过 MyKinsta 平台获得更多信息。这包括通过使用内置在 [MyKinsta 仪表板](https://kinsta.com/mykinsta/) 中的 [代码缩小功能](https://kinsta.com/help/kinsta-cdn-code-minification) ，快速轻松地提升您的整体优化，允许客户只需简单点击即可实现 CSS 和 JavaScript 的自动缩小。
